            ...
            <article id="page">
                ...
                <div class="article-container">
                    ...
                    <div class="skillbox">
                        ...
                        <div class="skillbar">
                            <div class="skillbar-title"
                                 style="background: linear-gradient(to right, #9900FF 0%, #CC66FF 100%); width: 20%">
                                <span>前端</span>
                            </div>
                        ...
                        <div class="skillbar">
                            <div class="skillbar-title"
                                 style="background: linear-gradient(to right, #2196F3 0%, #42A5F5 100%); width: 12%">
                                <span>Spring</span>
                            </div>
                        ...
                        <div class="skillbar">
                            <div class="skillbar-title"
                                 style="background: linear-gradient(to right, #00BCD4 0%, #80DEEA 100%); width: 15%">
                                <span>SpringMVC</span>
                            </div>
                        ...
                        <div class="skillbar">
                            <div class="skillbar-title"
                                 style="background: linear-gradient(to right, #00BCD4 0%, #f54009 100%); width: 20%">
                        ...
                        <div class="skillbar">
                            ...
                            <div class="skill-bar-percent">00%</div>
                        </div>
                        <div class="skillbar">
                            <div class="skillbar-title"
                                 style="background: linear-gradient(to right, #FFEB3B 0%, #FFF176 100%); width: 40%">
                                <span>数据结构与算法</span>
                            </div>
                        ...
                        <div class="skillbar">
                            <div class="skillbar-title"
                                 style="background: linear-gradient(to right, #e53bff 0%, #cd76ff 100%); width: 15%">
                                <span>MySQL</span>
                            </div>
                            <div class="skill-bar-percent">15%</div>
                        </div>
